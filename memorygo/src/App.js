...
let progressWidth = 500;
  return (
    <div>
      ...
      <input id='team1btn' type="button" onClick={ incCountT1 } placeholder='Points Team1'></input>
      <p>Points {countT1}</p>
      ...
      <input id='team2btn' type="button" onClick={incCountT2} placeholder='Points Team2'></input>
      <p>Points {countT2}</p>
